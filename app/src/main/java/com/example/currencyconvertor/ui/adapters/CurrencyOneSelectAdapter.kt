...
typealias ListenerOne = (dataUi: DataUi.Rate) -> Unit

class CurrencyOneSelectAdapter(private val listenerOne: ListenerOne) :
    ListAdapter<DataUi.Rate, CurrencyOneSelectAdapter.MainHolder>(ItemCallback),
